                ...
                <table class="table table-dark table-bordered align-middle table-hover tablesorter">
                    ...
                    <tbody>
                        <?php foreach ($rooms as $room): ?>
                            <tr class="room-row" data-number="<?= $room['number']; ?>" data-name="<?= $room['name']; ?>"
                                data-description="<?= $room['description']; ?>" data-type="<?= $room['type']; ?>"
                                ...
                                <td class="text-center">
                                    <?php if (!empty($room['image_path'])): ?>
                                        <img src="/<?= $room['image_path']; ?>" alt="Raumbild" class="img-thumbnail"
                ...
                <div class="modal-body">
                    <form id="submitRoomForm" action="/admin/rooms/create" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control bg-dark text-white border-white" id="roomName"
                                name="room_name" required>
                        </div>
                        <div class="mb-3">
                            <label for="roomNumber" class="form-label">Room Number</label>
                            <input type="number" class="form-control bg-dark text-white border-white" id="roomNumber"
                                name="room_number" required>
                        </div>

                        <div class="mb-3">
                            <label for="roomType" class="form-label">Room Type</label>
                            <select class="form-select bg-dark text-white border-white" id="roomType" name="room_type"
                                required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control bg-dark text-white border-white" id="roomDescription"
                                name="room_description" rows="3"></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="pricePerNight" class="form-label">Preis pro Nacht</label>
                            <input type="number" class="form-control bg-dark text-white border-white"
                                id="price_per_night" name="price_per_night" step="0.01" required>
                        </div>
                ...
                <div class="modal-body">
                    <form id="editRoomForm" action="/admin/rooms/edit" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select bg-dark text-white border-white" id="editType" name="type"
                                required>
                                <option value="">Select a type</option>
                                <option value="single">Single</option>
                                <option value="double">Double</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="editPricePerNight" name="price_per_night"
                                placeholder="Preis pro Nacht" class="form-control bg-dark text-white border-white"
                                required>
                        </div>
