    ...
    <div class="container mt-5 content-wrapper">
        <div class="row bg-dark text-white py-4 rounded">
            ...
            <div class="table-responsive">
                <table id="sortedTable" class="table table-dark table-bordered align-middle table-hover tablesorter" data-pagination="true">
                    <thead>
                        <tr>
                    ...
                    <form action="/admin/users/edit" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select bg-dark text-white border-white" id="editPronouns"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control bg-dark text-white border-white"
                                    id="editUsername" name="username" required />
                            </div>
                            <div class="mb-3">
                                <label for="editGivenname" class="form-label">Vorname</label>
                                <input type="text" class="form-control bg-dark text-white border-white"
                                    id="editGivenname" name="givenname" required />
                            </div>
                            <div class="mb-3">
                                <label for="editSurname" class="form-label">Nachname</label>
                                <input type="text" class="form-control bg-dark text-white border-white" id="editSurname"
                                    name="surname" required />
                            </div>
                            <div class="mb-3">
                                <label for="editEmail" class="form-label">E-Mail</label>
                                <input type="email" class="form-control bg-dark text-white border-white" id="editEmail"
                                    name="email" required />
                            </div>
                            <div class="mb-3">
                                <label for="editRole" class="form-label">Rolle</label>
                                <select class="form-select bg-dark text-white border-white" id="editRole" name="role"
                                    required>
                                    <option value="">Bitte wählen</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select bg-dark text-white border-white" id="editState" name="state"
                                    required>
                                    <option value="">Bitte wählen</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control bg-dark text-white border-white"
                    ...
                    <form action="/admin/users/add" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <select class="form-select bg-dark text-white border-white" id="addPronouns"
                                    name="pronouns" required>
                                    <option value="">Bitte wählen</option>
                                    <option value="Herr">Herr</option>
                                    <option value="Frau">Frau</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control bg-dark text-white border-white"
                                    id="addGivenname" name="givenname" required />
                            </div>
                            <div class="mb-3">
                                <label for="addSurname" class="form-label">Nachname</label>
                                <input type="text" class="form-control bg-dark text-white border-white" id="addSurname"
                                    name="surname" required />
                            </div>
                            <div class="mb-3">
                                <label for="addEmail" class="form-label">E-Mail</label>
                                <input type="email" class="form-control bg-dark text-white border-white" id="addEmail"
                                    name="email" required />
                            </div>
                            <div class="mb-3">
                                <label for="addRole" class="form-label">Rolle</label>
                                <select class="form-select bg-dark text-white border-white" id="addRole" name="role"
                                    required>
                                    <option value="">Bitte wählen</option>
                                    <option value="user">User</option>
                                    <option value="admin">Admin</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select bg-dark text-white border-white" id="addState" name="state"
                                    required>
                                    <option value="">Bitte wählen</option>
                                    <option value="active">Aktiv</option>
                                    <option value="inactive">Inaktiv</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control bg-dark text-white border-white" id="addUsername"
